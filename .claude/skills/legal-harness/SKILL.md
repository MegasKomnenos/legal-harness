...
| §5 표현 적절성 | 정형 표현 패턴 준수. 추정적·유보적 표현 부재 |
| §6 포섭 구체성 | 사실관계 적용이 구체적이며 과대·과소 서술 및 청구 범위 자발적 제약이 없는가 |
| §8 부분공개 | 판례 인용 깊이: 사실관계 비교가 충분한가 |
| §11 논증 충실성 | 소극적 논증 문맥: 문단 전체가 적극적 논증으로 구성되었는가 |
| §12 판례 적정성 | 그래프-문서 정합성: 그래프의 모든 법리가 반영, 순서 일치 |
| §13 출처 구별 | 조문 문언과 판례 해석이 구별되었는가. 판례 용어 선행 인용 |
| §14 역이용 위험 | 상대방이 역이용할 수 있는 논지가 없는가 |
