...
| **Phase 1 스크립트** | `validate_doc.py` (통합) |
| **Phase 2 트리거** | `validate_doc_content.py` (PostToolUse hook) → Agent 서브에이전트 |
...
| §16 | 작문 밀도: 판례 과잉 나열 없음, 인용→포섭→결론 전환 자연스러움, 중복 논증 없음, 분량 비례 | `05` §16 |
